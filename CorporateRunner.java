/*
Name:Donggi Lee
File:CorporateRunner
Class: ICS4U
Date: June 08, 2017
Description: The user enters options in the main menu to access the functionality of the whole project
Purpose: The user needs to be able to run the program.
    ...
    public class CorporateRunner 
   {
      ...
      //The Main Menu Screen 1-1
         ...
         //Sub Menu 2-1 Manage Expenditure
            ...
            //User enters wrong Data in the Menu
            else
            {
